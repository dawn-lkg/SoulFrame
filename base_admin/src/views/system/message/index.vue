    ...
    <a-card :bordered="false">
      <template #title>
        <div class="card-title">
          <span>消息中心</span>
          <div>
            <a-button v-if="activeTab === 'message'" style="margin-right: 10px;" type="primary"
                      @click="showNewMessageModal">
              发送消息
            </a-button>
            <a-button v-if="activeTab === 'notification'" style="margin-right: 10px;" type="primary"
                      @click="showSendNotificationModal">
              发送通知
            </a-button>
          ...
          >
            <template #renderItem="{ item }">
              <a-list-item>
                ...
                <template #actions>
                  <a-button v-if="!item.read" type="link" @click="markAsRead(item)">标为已读</a-button>
                  <a-button danger type="link" @click="deleteItem(item)">删除</a-button>
                </template>
              </a-list-item>
            </template>
          </a-list>
