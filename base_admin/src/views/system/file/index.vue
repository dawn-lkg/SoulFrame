<template>
    <div>
      <!-- <a-card title="文件管理" :bordered="false"> -->
        <a-row :gutter="16">
          <!-- 左侧筛选区域 -->
          <a-col :span="5">
            <a-card title="文件类型" :bordered="false" class="filter-card" style="height: 100vh;">
              <a-menu
              ...
              <div class="storage-info">
                <h4>存储空间</h4>
                <a-progress :percent="storageUsage" :stroke-color="getStorageColor()" />
          ...
          <!-- 右侧主内容区域 -->
          <a-col :span="19">
            <a-card title="文件管理" :bordered="false" style="height: 100vh;">
              <!-- 搜索表单 -->
              <a-form layout="inline" :model="queryParams">
                <a-form-item label="文件名称">
                <a-input v-model:value="queryParams.fileName" placeholder="请输入文件名称" />
              </a-form-item>
            ...
            <div v-else class="file-cards">
              <a-row :gutter="16">
                <a-col :span="4" v-for="file in filteredFileList" :key="file.fileId">
                  <a-card hoverable class="file-card">
                    ...
                    <template #actions>
                      ...
                      <delete-outlined key="delete" @click="confirmDelete(file)" />
                    </template>
                  </a-card>
  ...
  // 上传URL
  const uploadUrl = '/api/system/file/upload'
  ...
  const fileList = ref([
    {
      fileId: 1,
      fileName: '项目方案.docx',
      originalName: '项目方案.docx',
      fileType: 'document',
      fileSize: 1024 * 1024 * 2.5, // 2.5MB
      fileUrl: 'https://example.com/files/项目方案.docx',
      createBy: '管理员',
    ...
    },
    {
      ...
      createBy: '管理员',
      createTime: '2023-10-16 09:15:22',
      status: 0
    },
    {
      fileId: 3,
      ...
      fileUrl: 'https://example.com/files/需求文档.pdf',
      createBy: '张三',
      createTime: '2023-10-17 16:45:30',
      status: 0
    },
    {
      fileId: 4,
      ...
      fileType: 'video',
      fileSize: 1024 * 1024 * 35.2, // 35.2MB
      fileUrl: 'https://example.com/files/产品演示.mp4',
      createBy: '李四',
      createTime: '2023-10-18 11:20:15',
      status: 0
    },
    {
      fileId: 5,
      ...
      createBy: '王五',
      createTime: '2023-10-19 08:30:40',
      status: 0
    },
    {
      fileId: 6,
      fileName: '会议记录.docx',
      originalName: '会议记录.docx',
      fileType: 'document',
      fileSize: 1024 * 1024 * 1.2, // 1.2MB
      fileUrl: 'https://example.com/files/会议记录.docx',
      createBy: '管理员',
      createTime: '2023-10-20 15:10:25',
      status: 0
    },
    {
      fileId: 7,
      fileName: '系统日志.txt',
      originalName: '系统日志.txt',
      fileType: 'document',
      fileSize: 1024 * 1024 * 8.5, // 8.5MB
      fileUrl: 'https://example.com/files/系统日志.txt',
      createBy: '系统',
      createTime: '2023-10-21 00:00:00',
      status: 0
    },
    {
      fileId: 8,
      ...
      fileUrl: 'https://example.com/files/背景音乐.mp3',
      createBy: '赵六',
      createTime: '2023-10-22 09:45:50',
      status: 0
    }
  ])
  ...
  const filteredFileList = computed(() => {
    ...
    return fileList.value.filter(file => selectedFileTypes.value.includes(file.fileType))
  })
  ...
  const calculateUsedStorage = () => {
    usedStorage.value = fileList.value.reduce((total, file) => total + file.fileSize, 0)
  }
  ...
  const handleBatchDelete = () => {
    ...
    // 模拟批量删除
    fileList.value = fileList.value.filter(item => !selectedRowKeys.value.includes(item.fileId))
