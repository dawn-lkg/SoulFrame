<template>
  ...
  >
    <a-descriptions :column="2" bordered>
      ...
      <a-descriptions-item :span="2" label="调用目标字符串">{{ jobInfo.invokeTarget }}</a-descriptions-item>
      ...
      <a-descriptions-item label="状态">
        <a-badge :status="jobInfo.status === '0' ? 'success' : 'error'"
                 :text="jobInfo.status === '0' ? '正常' : '暂停'"/>
      </a-descriptions-item>
      <a-descriptions-item :span="2" label="备注">{{ jobInfo.remark }}</a-descriptions-item>
    </a-descriptions>
    <template #footer>
