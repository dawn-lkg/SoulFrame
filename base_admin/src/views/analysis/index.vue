          ...
          <a-row :gutter="[0, 16]">
            <a-col :span="12" class="progress-col">
              <div class="progress-container">
                <a-progress :format="percent => `${percent}%`" :percent="systemStatus.cpu" :stroke-color="getProgressColor(systemStatus.cpu)" :width="80"
                            type="dashboard"/>
            ...
            <a-col :span="12" class="progress-col">
              <div class="progress-container">
                <a-progress :format="percent => `${percent}%`" :percent="systemStatus.memory" :stroke-color="getProgressColor(systemStatus.memory)"
                            :width="80" type="dashboard"/>
...
import {
  getCpuMonitorInfo as getCpuMonitorInfoApi,
  getMemoryMonitorInfo as getMemoryMonitorInfoApi,
  getServerRunTime as getServerRunTimeApi
} from '@/api/modules/monitor-server';
import {
  RiseOutlined,
  FallOutlined,
  ReloadOutlined
...
import {
  realtime as getRealtimePerformanceApi,
  getPerformanceMetricsByHour as getPerformanceMetricsByHourApi,
  getPerformanceMetricsByWeek as getPerformanceMetricsByWeekApi
} from '@/api/modules/performance-metrics';
